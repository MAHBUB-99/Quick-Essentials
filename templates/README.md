...
-   login.html এবং register.html টেমপ্লেট ব্যবহার করে ইউজার কে লগইন এবং রেজিস্ট্রেশন করাতে হবে ।
...
-   প্রোডাক্ট ডিটেইলস পেজ অর্থাৎ details.html পেজের ক্ষেত্রে -
    ...
    -   সকল প্রডাক্ট এর Stock Manage করতে হবে ।
...
## Readme.md ফাইলে নিচের বিষয় গুলো অবশ্যই উল্লেখ করতে হবে -:

-   নতুন করে যুক্ত করা ফিচার গুলো অবশ্যই Github Readme তে গুছিয়ে লিখে দিতে হবে ।
